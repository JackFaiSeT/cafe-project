<template>
  <div class="product-card-item">
    ...
    <a href="#" class="image-wrapper">
      ...
      <img v-lazy-load :src="image.src" class="image isImageLoading" :alt="title" />
    </a>
    <div class="info">
      ...
      <div class="description" v-text="description" />
      <div class="info-bottom" :class="{ 'info-bottom--counted': Boolean(count) }">
        ...
        <button v-else type="button" class="button" @click="cartService.addToCart(id)">
          <v-icon name="cart" />
        </button>
      </div>
    </div>
...
const findItem = (array, item, prop) => {
  return array.find((cartItem) => cartItem[prop] === item[prop])
}
...
// TODO: Combine in receiving products
const count = computed(() => {
  return isReady.value ? findItem(cart.value, { id: props.id }, 'id')?.count || 0 : 0
})
